...
import com.murita.spring_api.entities.Payment;
...
import com.murita.spring_api.repositories.OrderItemRepository;
import com.murita.spring_api.repositories.OrderRepository;
import com.murita.spring_api.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    Payment pay1 = new Payment(null, Instant.parse("2024-08-24T15:30:49Z"), o1);
    o1.setPayment(pay1);
