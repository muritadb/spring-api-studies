...
public class TestConfig implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    Order o1 = new Order(null, Instant.parse("2024-08-24T13:30:49Z"), u1);
    Order o2 = new Order(null, Instant.parse("2024-07-29T20:10:20Z"), u2);
    Order o3 = new Order(null, Instant.parse("2024-08-06T05:27:05Z"), u1);
